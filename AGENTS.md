...
- For architecture, configuration, distribution, and observability details, see [SPEC.md](SPEC.md), [docs/configuration.md](docs/configuration.md), [docs/distribution.md](docs/distribution.md), and [docs/observability/README.md](docs/observability/README.md).
